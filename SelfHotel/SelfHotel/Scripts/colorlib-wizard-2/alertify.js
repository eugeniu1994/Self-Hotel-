! function (a, b) {
    ...
    c = function () {
        ...
        return r = {
            ...
            input: '<div class="alertify-text-wrapper"><input type="text" required="required" style="    font-family: Montserrat-Bold;font-size: 15px;line-height: 1.2;display: block;border-radius: 25px; padding: 0 30px 0 53px; border: 1px solid black !important;" class="alertify-text" id="alertify-text"></div>',
