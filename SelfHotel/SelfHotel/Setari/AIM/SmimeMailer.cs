...
namespace AegisImplicitMail
{
    ...
    public class SmimeMailer : MimeMailer
    {
        ...
        //    X509Certificate2 signingCertificate2 = null,
        //    X509Certificate2 encryptionCertificate2 = null, 
        //    SslMode sslType = SslMode.None, 
        //    bool sign = false,
        //    List<X509Certificate2> toSigningCerts = null, 
        //    List<X509Certificate2> toEncryptionCerts = null,
        //    AuthenticationType authenticationType = AuthenticationType.Base64, 
        //    bool encrypt = true)
        //    : base(host,port,userName,passWord,sslType,authenticationType)
        public SmimeMailer(
            string host, 
            int port, 
            string userName, 
            ...
            SslMode sslType, 
            bool sign,
            List<X509Certificate2> toSigningCerts, 
            List<X509Certificate2> toEncryptionCerts,
