...
namespace AegisImplicitMail
{
    ...
    class MailBuilder
    {
        ...
        //    string userName, 
        //    string passWord, 
        //    string senderEmailAddresss, 
        //    string senderDisplayName, 
        //    SslMode ssl = SslMode.None, 
        //    bool useHtml = true, 
        //    bool smime = false, 
        //    MailPriority messagePriority = MailPriority.Normal, 
        //    SendCompletedEventHandler onSendCallBack = null, 
        //    bool encrypt = false, 
        //    bool sign = false , 
        //    AuthenticationType authenticationType = AuthenticationType.PlainText)
        public MailBuilder(
            string host, 
            int port, 
            string userName, 
        ...
        //public void SendSecureMail(
        //    List<SmimeMailAddress> recieverMailAddresses, 
        //    string messageSubject, 
        //    string messageBody, 
        //    X509Certificate2 signingCertificate2, 
        //    List<string> attachmentAddress = null, 
        //    X509Certificate2 encryptionCertificate2 = null)
        public void SendSecureMail(
            List<SmimeMailAddress> recieverMailAddresses, 
            string messageSubject, 
            string messageBody, 
            X509Certificate2 signingCertificate2, 
            List<string> attachmentAddress, 
            X509Certificate2 encryptionCertificate2)
        {
        ...
        //public void SendImplicitMail(
        //    List<MailAddress> recieverMailAddresses, 
        //    MailPriority messagePriority, 
        //    string messageSubject, 
        //    string messageBody, 
        //    List<string> attachmentAddress = null, 
        //    List<MailAddress> ccMailAddresses = null, 
        //    List<MailAddress> bccMailAddresses = null)
        public void SendImplicitMail(
            List<MailAddress> recieverMailAddresses, 
            MailPriority messagePriority, 
            string messageSubject, 
            string messageBody, 
            List<string> attachmentAddress, 
            List<MailAddress> ccMailAddresses, 
            List<MailAddress> bccMailAddresses)
        {
