	...
	internal class SmtpSocketConnection :IDisposable
	{
     ...
     //   LocalCertificateSelectionCallback selectionCallback ;
        ...
        internal void Open(
            ...
            int timeout)
		{
            if (AIMExtensions.IsNullOrWhiteSpace(host) || port <= 0)
            {
	        ...
	        if (isSsl == SslMode.Ssl)
	        {
	            ...
	            if (clientcerts == null)
	            {
                    ...
                    var sslStream = new SslStream(_socket.GetStream(), true, _validationCallback, ClientCertificateSelectionCallback);
